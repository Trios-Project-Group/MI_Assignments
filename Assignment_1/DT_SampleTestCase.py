...
if __name__=="__main__":
	...
	print(get_entropy_of_attribute(df,"Shape"))
	print(get_selected_attribute(df))
	
	
	df = pd.read_csv("test-data_2.csv")
	print(get_entropy_of_dataset(df))
	print(get_entropy_of_attribute(df,"fever"))
	print(get_entropy_of_attribute(df,"cough"))
	print(get_entropy_of_attribute(df,"breathing_issues"))
